...
class ApprovedTickets extends StatefulWidget {
  final String eventName;
  const ApprovedTickets({Key? key, required this.eventName}) : super(key: key);

  @override
  State<ApprovedTickets> createState() => _ApprovedTicketsState();
}

class _ApprovedTicketsState extends State<ApprovedTickets> {
            ...
            builder: (BuildContext context,
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return  data.docs[index]['bStatus']=="true"?Card(
                      child: Column(
                            ...
                            children: <Widget>[
                              TextButton(
                                ...
                                onPressed: () async{
                                  ...
                                  if(eventid!='1'){
                                    final response =await WriteService.declinePayment(eventid);
                                    if(response=="1"){
                                      Loader.hide();
                                      MotionToast.success(
                                        title: const Text(
